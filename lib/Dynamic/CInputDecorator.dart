...
class CInputDecorator extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
        .add(DiagnosticsProperty<CInputDecoration>('decoration', decoration));
...
class _InputDecoratorState extends State<CInputDecorator>
  ...
  void didUpdateWidget(CInputDecorator old) {
    ...
    final bool floatBehaviourChanged =
...
class CInputDecoration {
  ...
  const CInputDecoration({
    ...
    this.errorStyle,
    this.errorMaxLines,
    @Deprecated('Use floatingLabelBehaviour instead. '
  ...
  CInputDecoration applyDefaults(InputDecorationTheme theme) {
    return copyWith(
      ...
      // ignore: deprecated_member_use_from_same_package
      hasFloatingPlaceholder: hasFloatingPlaceholder ?? false,
