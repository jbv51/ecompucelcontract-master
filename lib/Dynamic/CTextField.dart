...
class CTextField extends StatefulWidget {
  ...
  const CTextField({
    ...
    this.scrollPhysics,
        ...
        assert(maxLength == null ||
            maxLength == CTextField.noMaxLength ||
            maxLength > 0),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<CInputDecoration>(
        'decoration', decoration,
        defaultValue: const CInputDecoration()));
...
class _TextFieldState extends State<CTextField>
  ...
  CInputDecoration _getEffectiveDecoration() {
    ...
    final CInputDecoration effectiveDecoration =
        (widget.decoration ?? const CInputDecoration())
